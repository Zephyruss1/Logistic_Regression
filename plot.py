...
try:
    ...
    logreg_GDArmijo_weights, logreg_GDArmijo_objective = pkl.load(open('./results/logreg_GDArmijo.pkl', 'rb'))
    logreg_BFGS_weights, logreg_BFGS_objective = pkl.load(open('./results/logreg_BFGS.pkl', 'rb'))
    logreg_modifiedNewton_weights, logreg_modifiedNewton_objective = pkl.load(open('./results/logreg_ModifiedNewton.pkl', 'rb'))
    logreg_modifiedNewtonArmijo_weights, logreg_modifiedNewtonArmijo_objective = pkl.load(open('./results/logreg_ModifiedNewtonArmijo.pkl', 'rb'))
    logreg_levenbergMarquardt_weights, logreg_levenbergMarquardt_objective = pkl.load(open('./results/logreg_LevenbergMarquardt.pkl', 'rb'))
    logreg_ConjugateGradient_weights, logreg_ConjugateGradient_objective = pkl.load(open('./results/logreg_ConjugateGradient.pkl', 'rb'))
    logreg_ConjugateGradientArmijo_weights, logreg_ConjugateGradientArmijo_objective = pkl.load(open('./results/logreg_ConjugateGDArmijo.pkl', 'rb'))
    logreg_adam_weights, logreg_adam_objective = pkl.load(open('./results/logreg_adam.pkl', 'rb'))
    logreg_adamw_weights, logreg_adamw_objective = pkl.load(open('./results/logreg_adamw.pkl', 'rb'))
...
def plot_logreg():
    ...
    plt.figure()
    try:
        if logreg_adam_weights is not None and logreg_adamw_weights is not None and logreg_sgd_weights is not None and logreg_sgdw_weights is not None:
        ...
        if logreg_adam_objective is not None and logreg_adamw_objective is not None and logreg_sgd_objective is not None and logreg_sgdw_objective is not None:
    ...
    if args.optimizer in plot_objectives:
        ...
        plt.plot(range(len(optimizer_objective)), np.array(optimizer_objective) / np.sqrt(logreg_dimension),
